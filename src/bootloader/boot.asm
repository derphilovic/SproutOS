...
bdb_total_sectors:		dw 2880			;2880 * 512 = 1440000
...
ebr_volume_label:		db 'SPROUT   OS'	;11 bytes, padded with spaces
...
main:
	...
	;read sommething from floppy disk
...
lba_to_chs:
	...
	inc dx					;dc = LBA % SectorsPerTrack +1
	mov cx, dx				;cx = sector
...
.retry:
	...
	stc				;set carry flag, som bios don't set it
